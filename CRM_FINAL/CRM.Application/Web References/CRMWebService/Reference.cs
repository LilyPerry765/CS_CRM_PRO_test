...
namespace CRM.Application.CRMWebService {
    using System;
    ...
    public partial class CRMWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback SaveFailure117KarajOperationCompleted;
        ...
        public CRMWebService() {
            this.Url = global::CRM.Application.Properties.Settings.Default.CRM_Application_CRMWebService_CRMWebService;
        ...
        /// <remarks/>
        public event SaveFailure117KarajCompletedEventHandler SaveFailure117KarajCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SaveFailure117Karaj", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string SaveFailure117Karaj(long telephoneNo, long callingNo, [System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] recordeSound, out bool result, out bool isConfirmed) {
            object[] results = this.Invoke("SaveFailure117Karaj", new object[] {
                        telephoneNo,
                        callingNo,
                        recordeSound});
            result = ((bool)(results[1]));
        ...
        /// <remarks/>
        public void SaveFailure117KarajAsync(long telephoneNo, long callingNo, byte[] recordeSound) {
            this.SaveFailure117KarajAsync(telephoneNo, callingNo, recordeSound, null);
        }
        
        /// <remarks/>
        public void SaveFailure117KarajAsync(long telephoneNo, long callingNo, byte[] recordeSound, object userState) {
            if ((this.SaveFailure117KarajOperationCompleted == null)) {
                this.SaveFailure117KarajOperationCompleted = new System.Threading.SendOrPostCallback(this.OnSaveFailure117KarajOperationCompleted);
            }
            this.InvokeAsync("SaveFailure117Karaj", new object[] {
                        telephoneNo,
                        callingNo,
                        recordeSound}, this.SaveFailure117KarajOperationCompleted, userState);
        }
        
        private void OnSaveFailure117KarajOperationCompleted(object arg) {
            if ((this.SaveFailure117KarajCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.SaveFailure117KarajCompleted(this, new SaveFailure117KarajCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    public delegate void SaveFailure117KarajCompletedEventHandler(object sender, SaveFailure117KarajCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class SaveFailure117KarajCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal SaveFailure117KarajCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
