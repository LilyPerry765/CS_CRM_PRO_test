...
{
    public partial class E1BayList : Local.TabWindow
    {
        ...
        private void Initialize()
        {
            ...
            DDFColumn.ItemsSource = Data.E1DDFDB.GetDDFCheckable();
        ...
        private void Search(object sender, RoutedEventArgs e)
        {
            ...
            Pager.TotalRecords = Data.E1BayDB.SearchE1BayCount(
            CityComboBox.SelectedIDs,
            CenterComboBox.SelectedIDs,
            DDFComboBox.SelectedIDs,
            number);

            ItemsDataGrid.ItemsSource = Data.E1BayDB.SearchE1Bay(
            CityComboBox.SelectedIDs,
            CenterComboBox.SelectedIDs,
            DDFComboBox.SelectedIDs,
            number,
        ...
        private void DeleteItem(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    CRM.Data.E1Bay item = ItemsDataGrid.SelectedItem as CRM.Data.E1Bay;
                    DB.Delete<Data.E1Bay>(item.ID);
        ...
        private void EditItem(object sender, RoutedEventArgs e)
        {
            if (ItemsDataGrid.SelectedIndex >= 0)
            {
                ...
                E1BayForm window = new E1BayForm(item.ID);
                window.ShowDialog();
        ...
        {
            E1BayForm window = new E1BayForm();
            window.ShowDialog();
