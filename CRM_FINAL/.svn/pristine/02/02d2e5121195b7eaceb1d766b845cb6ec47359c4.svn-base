...
namespace CRM.Application.Reports.ReportUserControls
{
    ...
    /// </summary>
    public partial class ADSLSellerAgentSaleDetailesReportUserControl : Local.ReportBase
    {
        #region properties
        #endregion
        ...
        public ADSLSellerAgentSaleDetailesReportUserControl()
        {
            InitializeComponent();
            Initialize();
        }
        ...
        {
            CityComboBox.ItemsSource = CityDB.GetCitiesCheckable();
