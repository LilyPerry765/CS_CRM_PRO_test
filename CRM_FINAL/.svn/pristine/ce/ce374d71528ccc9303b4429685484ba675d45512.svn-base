<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="PAPEquipmentList.aspx.cs" Inherits="CRM.ADSLPortalKermanshah.PAPEquipmentList" %>
    ...
    <div class="Container">
        ...
        <div class="SearchRequest">
            <table class="Searchtable">
                ...
                <tr class="SearchRow">
                <td class="SearchColumnHeader">
                        <asp:Label ID="RowNoLabel" runat="server" Text="شماره ردیف : " />
                    </td>
                    <td class="SearchColumnValue">
                        <asp:TextBox ID="RowNoTextBox" runat="server" CssClass="SearchValue" />
                    </td>
                    <td class="SearchColumnHeader">
                        <asp:Label ID="ColumnNoLabel" runat="server" Text="شماره طبقه : " />
                    </td>
                    <td class="SearchColumnValue">
                        <asp:TextBox ID="ColumnNoTextBox" runat="server" CssClass="SearchValue" />
                    </td>
                    <td class="SearchColumnHeader">
                        <asp:Label ID="BuchtNoLabel" runat="server" Text="شماره اتصالی : " />
                    </td>
                    <td class="SearchColumnValue">
                        <asp:TextBox ID="BuchtNoTextBox" runat="server" CssClass="SearchValue" />
                    </td>
                </tr>
                <tr class="SearchRow">
                    ...
                    <table class="RequestGridHeader">
                        <tr>
                            ...
                            <td style="width: 30px; text-align: center;">
                                <asp:Label ID="PortNoLabel1" runat="server" Text="ردیف" />
                            </td>
                            <td style="width: 30px; text-align: center;">
                                <asp:Label ID="Label2" runat="server" Text="طبقه" />
                            </td>
                            <td style="width: 30px; text-align: center;">
                                <asp:Label ID="Label3" runat="server" Text="اتصالی" />
                            </td>
                            <td style="width: 50px; text-align: center;">
                ...
                <ItemTemplate>
                    <table width="100%" style="text-align: center;">
                        <tr class="EquipmentGridItems">
                            ...
                            <td style="width: 30px; text-align: center;">
                                <asp:Label ID="Label4" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"RowNo").ToString() %>'
                                    Font-Names="B Yekan" Font-Size="9pt" CssClass="ddd" />
                            </td>
                            <td style="width: 30px; text-align: center;">
                                <asp:Label ID="Label5" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"ColumnNo").ToString() %>'
                                    Font-Names="B Yekan" Font-Size="9pt" CssClass="ddd" />
                            </td>
                            <td style="width: 30px; text-align: center;">
                                <asp:Label ID="PortNoLabel2" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"BuchtNo").ToString() %>'
                                    Font-Names="B Yekan" Font-Size="9pt" CssClass="ddd" />
                            </td>
                            <td style="width: 50px; text-align: center;">
