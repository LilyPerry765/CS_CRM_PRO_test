...
namespace OfficeWebUI.Ribbon
{
    ...
    public class LargeItem : ControlAncestor, IPostBackEventHandler, IOfficeWebUIWebControl
    {
        ...
        private bool _hasTabWindow = false;
        ...
        [Browsable(true)]
        [Category("Appearance")]
        public bool HasTabWindow
        {
            get { return this._hasTabWindow; }
            set { this._hasTabWindow = value; }
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            lTableCellText.Style.Add("height", "23px");
            lTableCellText.Style.Add("max-width", "70px");
            lTableCellText.Style.Add("overflow", "hidden");
