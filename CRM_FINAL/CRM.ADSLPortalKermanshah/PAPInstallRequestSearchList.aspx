<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="PAPInstallRequestSearchList.aspx.cs" Inherits="CRM.ADSLPortalKermanshah.PAPInstallRequestSearchList" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%--<%@ Register Assembly="PersianDateControls 2.0" Namespace="PersianDateControls" TagPrefix="pdc" %>--%>
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    <title>جستجو درخواست دایری</title>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="Container">
        <div class="Header" style="width: 98%">
            <asp:Label ID="lblNewsHeader" runat="server" Text="جستجو درخواست دایری" />
        </div>
                            ...
                            <LayoutTemplate>
                                <table class="RequestGridHeader">
                                    <tr>
                                        ...
                                        <td style="width: 50px;">
                                            <asp:Label ID="SplitorBuchtLabel" runat="server" Text="بوخت" />
                                        </td>
                                        <%--<td style="width: 50px;">
