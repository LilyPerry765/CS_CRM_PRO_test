<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="PAPInstallRequestForm.aspx.cs" Inherits="CRM.ADSLPortalKermanshah.PAPInstallRequestForm" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="Container">
        <div class="Header">
            <asp:Label ID="lblNewsHeader" runat="server" Text="ثبت درخواست دایری" />
        </div>
        <table class="RequestTabel">
            ...
            <tr class="RequestRow">
                ...
                <td class="RequestColumnValue">
                    ...
                    <asp:Button ID="DebtButton" runat="server" OnClick="Click" Text="امکان سنجی" CssClass="ButtonValue" />
            ...
            <tr class="RequestRow">
                <td class="RequestColumnHeader">
                    <asp:Label ID="RowLabel" runat="server" Text="ردیف : " />
                </td>
                <td class="RequestColumnValue">
                    ...
                    <a href="PAPEquipmentList.aspx" target="_blank" class="EquipmentLink">نمایش تجیهزات
                        فنی در پنجره جدید</a>
                    <%--<asp:RequiredFieldValidator ID="RowValidator1" runat="server" ControlToValidate="RowTextBox"
                        ValidationGroup="SaveGroup" ErrorMessage="* لطفا ردیف را وارد نمایید !" CssClass="ErrorMessage"
                        Display="Dynamic" />--%>
                    <asp:RegularExpressionValidator ID="RowValidator2" runat="server" ControlToValidate="RowTextBox"
            ...
            <tr class="RequestRow">
                <td class="RequestColumnHeader">
                    <asp:Label ID="ColumnLabel" runat="server" Text="طبقه : " />
                </td>
                <td class="RequestColumnValue">
            ...
            <tr class="RequestRow">
                <td class="RequestColumnHeader">
                    <asp:Label ID="BuchtLabel" runat="server" Text="اتصالی : " />
                </td>
                <td class="RequestColumnValue">
