<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="PAPExchangeRequestSearchList.aspx.cs" Inherits="CRM.ADSLPortalKermanshah.PAPExchangeRequestSearchList" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    <title>جستجو درخواست تعویض پورت</title>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="Container">
        <div class="Header" style="width: 98%">
            <asp:Label ID="lblNewsHeader" runat="server" Text="جستجو درخواست تعویض پورت" />
        </div>
