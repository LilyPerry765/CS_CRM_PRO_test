<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="True"
    CodeBehind="PAPDischargeRequestList.aspx.cs" Inherits="CRM.ADSLPortal.PAPDischargeRequestList" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%--<%@ Register Assembly="PersianDateControls 2.0" Namespace="PersianDateControls" TagPrefix="pdc" %>--%>
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    <title>پیگیری درخواست تخلیه</title>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="Container">
        <div class="Header" style="width: 98%;">
            <asp:Label ID="lblNewsHeader" runat="server" Text="پیگیری درخواست تخلیه" />
        </div>
                            ...
                            <LayoutTemplate>
                                <table class="RequestGridHeader">
                                    <tr>
                                        ...
                                        <td style="width: 50px; text-align: center;">
                                            <asp:Label ID="SplitorBuchtLabel1" runat="server" Text="پورت" />
                                        </td>
                                        <%--<td style="width: 50px; text-align: center;">
