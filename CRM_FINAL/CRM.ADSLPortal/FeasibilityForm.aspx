<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="FeasibilityForm.aspx.cs" Inherits="CRM.ADSLPortal.FeasibilityForm" %>
        ...
        <table class="RequestTabel">
            ...
            <tr class="RequestRow">
                <td class="RequestColumnHeader">
                    <asp:Label ID="TelephoneNoLabel" runat="server" Text="شماره تماس : " />
                </td>
                <td class="RequestColumnValue">
                    ...
                    <asp:RegularExpressionValidator ID="TelephoneNoRegular" runat="server" ControlToValidate="TelephoneNoTextBox"
                        ValidationGroup="SendGroup" ErrorMessage="* لطفا شماره تلفن صحیح 10 رقمی را وارد نمایید !"
