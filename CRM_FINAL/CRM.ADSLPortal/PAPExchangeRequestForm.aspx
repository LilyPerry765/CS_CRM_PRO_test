<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="PAPExchangeRequestForm.aspx.cs" Inherits="CRM.ADSLPortal.PAPExchangeRequestForm" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="Container">
        ...
        <table class="RequestTabel">
            ...
            <tr class="RequestRow">
                <td class="RequestColumnHeader">
                    <asp:Label ID="SpliterBuchtLabel" runat="server" Text="پورت قدیم : " />
                </td>
                <td class="RequestColumnValue">
                    <%--<asp:Label ID="SpliterColumnLabel" runat="server" Text="ردیف : " CssClass="BuchtHeader" />--%>
                    <asp:TextBox ID="OldPortColumnTextBox" runat="server" CssClass="RequestValue" />
                    <asp:RequiredFieldValidator ID="SpliterColumnValidator" runat="server" ControlToValidate="OldPortColumnTextBox"
                        ValidationGroup="SaveGroup" ErrorMessage="* لطفا پورت قدیم را وارد نمایید !" CssClass="ErrorMessage"
                        Display="Dynamic" />
                    <asp:RegularExpressionValidator ID="SpliterColumnRegular" runat="server" ControlToValidate="OldPortColumnTextBox"
                        ValidationGroup="SaveGroup" ErrorMessage="* لطفا پورت قدیم معتبر وارد نمایید !" CssClass="ErrorMessage"
            ...
            <tr class="RequestRow">
                <td class="RequestColumnHeader">
                    <asp:Label ID="Label2" runat="server" Text="پورت جدید : " />
                </td>
                <td class="RequestColumnValue">
                    <%--<asp:Label ID="SpliterColumnLabel" runat="server" Text="ردیف : " CssClass="BuchtHeader" />--%>
                    <asp:TextBox ID="NewPortColumnTextBox" runat="server" CssClass="RequestValue" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="NewPortColumnTextBox"
                        ValidationGroup="SaveGroup" ErrorMessage="* لطفا پورت جدید را وارد نمایید !" CssClass="ErrorMessage"
                        Display="Dynamic" />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="NewPortColumnTextBox"
                        ValidationGroup="SaveGroup" ErrorMessage="* لطفا پورت جدید معتبر وارد نمایید !" CssClass="ErrorMessage"
                        Display="Dynamic" ValidationExpression="^\d+$" />
                    <%--<asp:Label ID="SpliterRowLabel" runat="server" Text="طبقه : " CssClass="BuchtHeader" />
                    <asp:RequiredFieldValidator ID="SpliterRowValidator" runat="server" ControlToValidate="SpliterRowTextBox"
                        ValidationGroup="SaveGroup" ErrorMessage=" * " CssClass="ErrorMessage" Display="Dynamic" />
