...
$(function () {
    ...
    function ProvinceProgram_ViewModel() {
        ...
        $.getJSON(url, function (data) {
            ...
            var Total_Leakage_Digits = Math.round(Total_Leakage / 1000000).toString().length; 
            if(Total_Leakage_Digits < 5)
            {
                Total_Leakage_Digits = 5;
            }
            console.log("Total Leakage Digits : " + Total_Leakage_Digits);
            $("#TotalLeakage_SevenSegment").sevenSeg({
                colorBackground: 'white',
                colorOff: 'rgb(247, 247, 247)',
                colorOn: Total_LeaKage_Color,
                digits: Total_Leakage_Digits,
            ...
            var Recoverable_Digits = Math.round(Recoverable_Leakage / 1000000).toString().length; 
            if(Recoverable_Digits < 5)
            {
                Recoverable_Digits = 5;
            }
            console.log("Recoverable Digits : " + Recoverable_Digits);
            $("#Recoverable_SevenSegment").sevenSeg({
                colorBackground: 'white',
                colorOff: 'rgb(247, 247, 247)',
                colorOn: Recoverable_Leakage_Color,
                digits: Recoverable_Digits,
            ...
            var Recovered_Digits = Math.round(Recovered_ / 1000000).toString().length; 
            if(Recovered_Digits < 5)
            {
                Recovered_Digits = 5;
            }
            console.log("Recovered Digits : " + Recovered_Digits);
       
            $("#Recovered_SevenSegment").sevenSeg({
                colorBackground: 'white',
                colorOff: 'rgb(247, 247, 247)',
                colorOn: Recovered_Color,
                digits:  Recovered_Digits,
