...
using System.IO;
    ...
    [ConnectionKey("Default"), DisplayName("گزارش فنی فعالیت"), InstanceName("گزارش فنی فعالیت"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.JustRead)]
    [ModifyPermission(Case.PermissionKeys.Activity)]
    public sealed class ActivityRequestRow : Row, IIdRow
    {
      ...
      // }
        ...
        public class RowFields : RowFieldsBase
        {
           ...
           // public Int32Field Cycle;
            ...
            {
                LocalTextPrefix = "Case.ActivityRequest";
            }
        }
    }
}