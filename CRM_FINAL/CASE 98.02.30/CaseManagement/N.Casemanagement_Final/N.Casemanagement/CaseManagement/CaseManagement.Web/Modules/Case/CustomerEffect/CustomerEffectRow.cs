...
namespace CaseManagement.Case.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("اثر بر مشتری"), InstanceName("اثر بر مشتری"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.JustRead)]
    [ModifyPermission(Case.PermissionKeys.Activity)]
    [LookupScript("Case.CustomerEffect")]
    public sealed class CustomerEffectRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("[dbo].[CustomerEffect]")
            {
                LocalTextPrefix = "Case.CustomerEffect";
            }
        }
    }
}