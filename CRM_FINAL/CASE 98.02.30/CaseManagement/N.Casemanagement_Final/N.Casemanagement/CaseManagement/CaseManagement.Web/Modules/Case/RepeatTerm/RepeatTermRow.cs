...
namespace CaseManagement.Case.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("تکرار دوره فعالیت"), InstanceName("تکرار دوره فعالیت"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.JustRead)]
    [ModifyPermission(Case.PermissionKeys.Activity)]
    [LookupScript("Case.RepeatTerm")]
    public sealed class RepeatTermRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("مقدار"), Column("DayValue")]
        public Int32? DayValue
        {
            get { return Fields.DayValue[this]; }
            set { Fields.DayValue[this] = value; }
        }

        [DisplayName("تعداد دفعات تکرار مطلوب در سال"), Column("RequiredYearRepeatCount")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("[dbo].[RepeatTerm]")
            {
                LocalTextPrefix = "Case.RepeatTerm";
            }
        }
    }
}