namespace CaseManagement.Case {
    export namespace ActivityService {
        export const baseUrl = 'Case/Activity';
        ...
        export declare function ActivitybyGroupList(request: ActivityRequest, onSuccess?: (response: ActivityResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        export namespace Methods {
            ...
            export declare const ActivitybyGroupList: string;
        }

        ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'ActivitybyGroupList'].forEach(x => {
