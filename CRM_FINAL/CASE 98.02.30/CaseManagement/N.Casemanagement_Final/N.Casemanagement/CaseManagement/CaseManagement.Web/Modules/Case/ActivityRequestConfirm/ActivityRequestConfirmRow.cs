...
namespace CaseManagement.Case.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("فعالیت تایید شده"), InstanceName("فعالیت تایید شده"), TwoLevelCached]
   // [ReadPermission(Administration.PermissionKeys.User)]
   // [ModifyPermission(Administration.PermissionKeys.User)]

    [ReadPermission(Case.PermissionKeys.JustRead)]
    [ModifyPermission(Case.PermissionKeys.Activity)]
    public sealed class ActivityRequestConfirmRow : Row, IIdRow
    {
        ...
        public ActivityRequestConfirmRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            {
                LocalTextPrefix = "Case.ActivityRequestConfirm";
            }
        }
    }
}