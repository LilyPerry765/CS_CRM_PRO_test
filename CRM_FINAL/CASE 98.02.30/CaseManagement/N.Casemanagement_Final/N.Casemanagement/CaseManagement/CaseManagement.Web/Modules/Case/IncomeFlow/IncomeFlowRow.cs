...
namespace CaseManagement.Case.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("جریان درآمدی"), InstanceName("جریان درآمدی"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.JustRead)]
    [ModifyPermission(Case.PermissionKeys.Activity)]
    [LookupScript("Case.IncomeFlow")]
    public sealed class IncomeFlowRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("[dbo].[IncomeFlow]")
            {
                LocalTextPrefix = "Case.IncomeFlow";
            }
        }
    }
}