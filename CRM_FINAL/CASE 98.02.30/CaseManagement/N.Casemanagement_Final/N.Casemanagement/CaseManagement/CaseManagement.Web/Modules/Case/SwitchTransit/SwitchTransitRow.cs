...
namespace CaseManagement.Case.Entities
{
    ...
    [LookupScript("Case.SwitchTransit")]
    public sealed class SwitchTransitRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("[dbo].[SwitchTransit]")
            {
                LocalTextPrefix = "Case.SwitchTransit";
            }
        }
    }
}