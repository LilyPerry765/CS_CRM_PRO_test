...
namespace CaseManagement.Case.Entities
{
    ...
    [LookupScript("Case.ActivityRequestPenddingRow")]
    public sealed class ActivityRequestPenddingRow : Row, IIdRow
    {
        ...
        public ActivityRequestPenddingRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            {
                LocalTextPrefix = "Case.ActivityRequestPendding";
            }
        }
    }
}