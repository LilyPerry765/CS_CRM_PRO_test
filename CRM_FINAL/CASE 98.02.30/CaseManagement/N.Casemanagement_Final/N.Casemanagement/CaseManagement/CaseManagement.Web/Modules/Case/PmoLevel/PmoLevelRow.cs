...
namespace CaseManagement.Case.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("سطح PMO"), InstanceName("سطح PMO"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.JustRead)]
    [ModifyPermission(Case.PermissionKeys.Activity)]
    [LookupScript("Case.PmoLevel")]
    public sealed class PmoLevelRow : Row, IIdRow, INameRow
    {
