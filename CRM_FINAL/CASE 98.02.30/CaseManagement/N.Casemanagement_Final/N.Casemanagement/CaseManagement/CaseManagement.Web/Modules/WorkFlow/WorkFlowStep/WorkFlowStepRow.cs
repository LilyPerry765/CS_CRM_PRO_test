...
namespace CaseManagement.WorkFlow.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("مرحله"), InstanceName("مرحله"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.Workflow)]
    [ModifyPermission(Case.PermissionKeys.Manager)]
    [LookupScript("WorkFlow.WorkFlowStep")]
    public sealed class WorkFlowStepRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("[dbo].[WorkFlowStep]")
            {
                LocalTextPrefix = "WorkFlow.WorkFlowStep";
            }
        }
    }
}