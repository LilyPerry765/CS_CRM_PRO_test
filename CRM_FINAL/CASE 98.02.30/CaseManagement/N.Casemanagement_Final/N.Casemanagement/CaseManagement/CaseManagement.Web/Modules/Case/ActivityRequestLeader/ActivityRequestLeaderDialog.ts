...
namespace CaseManagement.Case {
    ...
    export class ActivityRequestLeaderDialog extends Serenity.EntityDialog<ActivityRequestLeaderRow, any> {
        protected getFormKey() { return ActivityRequestLeaderForm.formKey; }
        ...
        protected form = new ActivityRequestLeaderForm(this.idPrefix);
