...
namespace CaseManagement.Case.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("سطح ریسک"), InstanceName("سطح ریسک"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.JustRead)]
    [ModifyPermission(Case.PermissionKeys.Activity)]
    [LookupScript("Case.RiskLevel")]
    public sealed class RiskLevelRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("[dbo].[RiskLevel]")
            {
                LocalTextPrefix = "Case.RiskLevel";
            }
        }
    }
}