namespace CaseManagement.Case {
    export interface CustomerEffectRow {
        Id?: number;
        Name?: string;
    ...
    export namespace CustomerEffectRow {
        export const idProperty = 'Id';
        export const nameProperty = 'Name';
        export const localTextPrefix = 'Case.CustomerEffect';
        export const lookupKey = 'Case.CustomerEffect';

        export function getLookup(): Q.Lookup<CustomerEffectRow> {
            return Q.getLookup<CustomerEffectRow>('Case.CustomerEffect');
        }
