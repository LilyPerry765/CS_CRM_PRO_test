...
namespace CaseManagement.Case.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("Software"), InstanceName("Software"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.BasicInfo)]
    [ModifyPermission(Case.PermissionKeys.BasicInfo)]
    public sealed class SoftwareRow : Row, IIdRow, INameRow
    {
