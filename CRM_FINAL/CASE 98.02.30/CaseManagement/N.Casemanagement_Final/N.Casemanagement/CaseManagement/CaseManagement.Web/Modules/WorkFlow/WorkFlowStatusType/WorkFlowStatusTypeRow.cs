...
namespace CaseManagement.WorkFlow.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("نوع وضیعت"), InstanceName("نوع وضیعت"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.Workflow)]
    [ModifyPermission(Case.PermissionKeys.Manager)]
    [LookupScript("WorkFlow.WorkFlowStatusType")]
    public sealed class WorkFlowStatusTypeRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("[dbo].[WorkFlowStatusType]")
            {
                LocalTextPrefix = "WorkFlow.WorkFlowStatusType";
            }
        }
    }
}