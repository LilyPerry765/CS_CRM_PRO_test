...
namespace CaseManagement.Case.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("فعالیت های رد شده"), InstanceName("فعالیت های رد شده"), TwoLevelCached]
    [ReadPermission(Case.PermissionKeys.JustRead)]
    [ModifyPermission(Case.PermissionKeys.Activity)]
    public sealed class ActivityRequestDenyRow : Row, IIdRow
    {
        ...
        [DisplayName("مبلغ غیر قابل وصول")]
        ...
        [DisplayName("فعالیت"), Column("ActivityID"), ForeignKey("[dbo].[Activity]", "ID"), LeftJoin("jActivity"), TextualField("ActivityName")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            {
                LocalTextPrefix = "Case.ActivityRequestDeny";
            }
        }
    }
}