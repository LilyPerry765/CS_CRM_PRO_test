...
namespace CaseManagement.Case.Entities
{
    ...
    public sealed class ActivityRequestTechnicalRow : Row, IIdRow
    {
        ...
        //[DisplayName("Required Year Repeat Count"), Hidden, Expression("jActivity.RepeatTermId"), TextualField("ActivityName"), LookupInclude]
        ...
        public ActivityRequestTechnicalRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            {
                LocalTextPrefix = "Case.ActivityRequestTechnical";
            }
        }
    }
}