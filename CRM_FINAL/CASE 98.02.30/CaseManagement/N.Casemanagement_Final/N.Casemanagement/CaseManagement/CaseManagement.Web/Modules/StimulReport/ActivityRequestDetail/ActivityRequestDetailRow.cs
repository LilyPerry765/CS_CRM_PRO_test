...
namespace CaseManagement.StimulReport.Entities
{
    ...
    public sealed class ActivityRequestDetailRow : Row, IIdRow
    {
        ...
        public ActivityRequestDetailRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            {
                LocalTextPrefix = "StimulReport.ActivityRequestDetail";
            }
        }
    }
}