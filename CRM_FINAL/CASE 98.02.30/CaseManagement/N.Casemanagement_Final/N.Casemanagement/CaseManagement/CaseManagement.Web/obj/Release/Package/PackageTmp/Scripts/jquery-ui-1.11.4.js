...
$.extend(Datepicker.prototype, {
	...
	_attachments: function(input, inst) {
		var showOn, buttonText, buttonImage,
			...
			isRTL = false; //[CC] //isRTL = this._get(inst, "isRTL");
	...
	_gotoToday: function(id) {
		...
		if (this._get(inst, "gotoCurrent") && inst.currentDay) {
			...
			var date = new this.CDate(); //[CC] date = new Date();
	...
	parseDate: function (format, value, settings) {
		...
		var iFormat, dim, extra,
			...
			shortYearCutoff = (typeof shortYearCutoffTemp !== "string" ? shortYearCutoffTemp :
				new this.CDate().getFullYear() % 100 + parseInt(shortYearCutoff, 10));  //[CC] new Date().getFullYear() % 100 + parseInt(shortYearCutoffTemp, 10)),
			...
			if (literal) {
				...
				switch (format.charAt(iFormat)) {
					...
					case "y":
						...
						break;
					case "@":
						date = new this.CDate(getNumber('@')); //[CC] date = new Date(getNumber("@"));
		...
		if (year === -1) {
			year = new this.CDate().getFullYear(); //[CC] year = new Date().getFullYear();
		} else if (year < 100) {
		...
		date = this._daylightSavingAdjust(new this.CDate(year, month - 1, day)); //[CC] this._daylightSavingAdjust(new Date(year, month - 1, day));
	...
	_getDefaultDate: function(inst) {
		...
		return this._restrictMinMax(inst,this._determineDate(inst, this._get(inst, 'defaultDate'), new this.CDate()));//[CC]
	},
	...
	_generateHTML: function(inst) {
		...
		prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			"<a style='direction:ltr' class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click'" +  //[CC] RTL
			" title='" + prevText + "'><span class='ui-icon ui-icon-circle-triangle-" + ( isRTL ? "e" : "w") + "'>" + prevText + "</span></a>" :
			(hideIfNoPrevNext ? "" : "<a style='direction:ltr' class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='"+ prevText +"'><span class='ui-icon ui-icon-circle-triangle-" + ( isRTL ? "e" : "w") + "'>" + prevText + "</span></a>"));  //[CC] RTL
		...
		next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			"<a style='direction:ltr' class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click'" +  // [CC] RTL
			" title='" + nextText + "'><span class='ui-icon ui-icon-circle-triangle-" + ( isRTL ? "w" : "e") + "'>" + nextText + "</span></a>" :
			(hideIfNoPrevNext ? "" : "<a style='direction:ltr' class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+ nextText + "'><span class='ui-icon ui-icon-circle-triangle-" + ( isRTL ? "w" : "e") + "'>" + nextText + "</span></a>")); // [CC] RTL
