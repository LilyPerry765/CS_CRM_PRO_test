...
namespace CaseManagement.Case {
    ...
    export class ActivityRequestConfirmGrid extends Serenity.EntityGrid<ActivityRequestConfirmRow, any> {
        protected getColumnsKey() { return 'Case.ActivityRequestConfirm'; }
        protected getDialogType() { return ActivityRequestConfirmDialog; }
