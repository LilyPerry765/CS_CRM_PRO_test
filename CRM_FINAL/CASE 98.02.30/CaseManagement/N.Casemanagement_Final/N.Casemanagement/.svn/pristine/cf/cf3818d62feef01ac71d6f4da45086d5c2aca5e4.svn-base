    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your CaseManagement Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your CaseManagement Account";
                    ...
                    public static LocalText FormTitle = "Sign up for CaseManagement";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "CaseManagement";
        }
