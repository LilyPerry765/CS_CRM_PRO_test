namespace CaseManagement.Case {
    export interface ActivityRequestConfirmAdminRow {
        Id?: number;
        Count?: number;
        CycleCost?: number;
        Factor?: number;
    ...
    export namespace ActivityRequestConfirmAdminRow {
        export const idProperty = 'Id';
        export const localTextPrefix = 'Case.ActivityRequestConfirmAdmin';
