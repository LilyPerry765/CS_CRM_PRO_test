namespace CaseManagement.Case {
    export class ActivityRequestConfirmForm extends Serenity.PrefixedContext {
        static formKey = 'Case.ActivityRequestConfirm';

    }

    export interface ActivityRequestConfirmForm {
