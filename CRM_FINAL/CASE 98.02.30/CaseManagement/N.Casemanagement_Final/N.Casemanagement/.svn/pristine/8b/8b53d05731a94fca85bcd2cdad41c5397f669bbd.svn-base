      ...
      // }
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow>
        {
            ...
            protected override void ValidateRequest()
            {
                ...
                if (IsCreate)
                {
                    ...
                    Case.Helper.SaveLog("Users", "کاربر", 0, Row.Username, "", Connection, Administration.ActionLog.Insert);
                }
                ...
                if (IsUpdate)
                {
                    ...
                    Case.Helper.SaveLog("Users", "کاربر", Row.UserId.Value, Row.Username, "", Connection, Administration.ActionLog.Update);
                }
            }
        ...
        private class MyListHandler : ListRequestHandler<MyRow> {
            protected override void ApplyFilters(SqlQuery query)
            {
                ...
                Case.Helper.SaveLog("Users", "کاربر", 0, "مشاهده لیست", "", Connection, Administration.ActionLog.View);
            }
        }
    }
}
