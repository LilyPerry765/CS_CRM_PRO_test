namespace CaseManagement.Case {
    export interface ActivityRequestDenyRow {
        Id?: number;
        Count?: number;
        CycleCost?: number;
        Factor?: number;
    ...
    export namespace ActivityRequestDenyRow {
        export const idProperty = 'Id';
        export const localTextPrefix = 'Case.ActivityRequestDeny';
