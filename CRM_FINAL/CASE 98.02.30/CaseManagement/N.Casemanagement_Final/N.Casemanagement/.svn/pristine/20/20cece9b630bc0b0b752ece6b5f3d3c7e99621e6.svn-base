...
namespace CaseManagement.Case.Entities
{
    ...
    [ReadPermission(Administration.PermissionKeys.Manager)]
    [ModifyPermission(Administration.PermissionKeys.Manager)]
    public sealed class ActivityRequestConfirmAdminRow : Row, IIdRow
    {
        ...
        public RequestActionAdmin? ActionID
        {
            get { return (RequestActionAdmin?)Fields.ActionID[this]; }
        ...
        public ActivityRequestConfirmAdminRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            {
                LocalTextPrefix = "Case.ActivityRequestConfirmAdmin";
            }
        }
    }
}