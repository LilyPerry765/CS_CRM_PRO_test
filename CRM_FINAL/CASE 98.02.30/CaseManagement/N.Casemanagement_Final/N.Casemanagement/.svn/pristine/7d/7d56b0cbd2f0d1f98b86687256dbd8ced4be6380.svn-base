namespace CaseManagement.WorkFlow {
    export interface WorkFlowStatusTypeRow {
        Id?: number;
        Name?: string;
    ...
    export namespace WorkFlowStatusTypeRow {
        export const idProperty = 'Id';
        export const nameProperty = 'Name';
        export const localTextPrefix = 'WorkFlow.WorkFlowStatusType';
        export const lookupKey = 'WorkFlow.WorkFlowStatusType';

        export function getLookup(): Q.Lookup<WorkFlowStatusTypeRow> {
            return Q.getLookup<WorkFlowStatusTypeRow>('WorkFlow.WorkFlowStatusType');
        }
