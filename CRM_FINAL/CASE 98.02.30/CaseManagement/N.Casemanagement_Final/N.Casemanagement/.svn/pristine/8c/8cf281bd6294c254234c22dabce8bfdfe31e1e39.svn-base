namespace CaseManagement.WorkFlow {
    ...
    export namespace WorkFlowStepRow {
        export const idProperty = 'Id';
        export const nameProperty = 'Name';
        export const localTextPrefix = 'WorkFlow.WorkFlowStep';
        export const lookupKey = 'WorkFlow.WorkFlowStep';

        export function getLookup(): Q.Lookup<WorkFlowStepRow> {
            return Q.getLookup<WorkFlowStepRow>('WorkFlow.WorkFlowStep');
        }
