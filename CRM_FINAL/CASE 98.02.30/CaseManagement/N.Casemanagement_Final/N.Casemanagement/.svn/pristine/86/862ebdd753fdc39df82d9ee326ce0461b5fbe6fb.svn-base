...
namespace CaseManagement.Case.Entities
{
    ...
    [ReadPermission(Case.PermissionKeys.BasicInfo)]
    [ModifyPermission(Case.PermissionKeys.BasicInfo)]
    public sealed class ActivityRequestDeleteRow : Row, IIdRow, INameRow
    {
        [DisplayName("شناسه"), Column("ID"), Identity, QuickSearch]
        public Int64? Id
        {
        ...
        [DisplayName("تاریخ شناسایی نشتی"), NotNull]
        ...
        [LookupEditor("Case.Cycle"), NotNull]
        ...
        [LookupEditor("Case.IncomeFlow"), NotNull]
        ...
        {
            get { return Fields.ActivityCode; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public ActivityRequestDeleteRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            {
                LocalTextPrefix = "Case.ActivityRequestDelete";
            }
        }
    }
}