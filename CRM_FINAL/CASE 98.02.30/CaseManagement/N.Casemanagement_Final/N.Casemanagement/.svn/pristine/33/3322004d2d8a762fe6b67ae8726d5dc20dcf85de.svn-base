namespace CaseManagement.Case {
    export interface ActivityRequestDeleteRow {
        Id?: number;
        Count?: number;
        CycleCost?: number;
        Factor?: number;
    ...
    export namespace ActivityRequestDeleteRow {
        export const idProperty = 'Id';
        export const nameProperty = 'ActivityCode';
        export const localTextPrefix = 'Case.ActivityRequestDelete';
